...
PROGRAMAS = [
    {
        ...
        "paleta": [("#ED1877", "Rosa"), ("#FFFFFF", "Blanco"), ("#000000", "Negro")],
    ...
    },
    {
        ...
        "tagline": "Preguntas pequeñas. Grandes conversaciones.",
        "unalinea": "La mirada de los chicos sobre el mundo de los grandes: cinco chicos de 8 a 12 "
                    "entrevistan adultos, comparten sus historias y preguntan lo que quieren saber.",
        "accent": "#FFD21C", "accent2": "#FFE68A", "glow": "#071A3D",
        "lockup": "Streaming IRL · @pequenosgrandessabios",
        "logo": "logo-pequenos-grandes-sabios.png", "logo_bg": "#071A3D",
        "ficha_rapida": [("Formato", "Streaming IRL en vivo"),
                         ("Duración", "45–60 min"),
        ...
        "paleta": [("#071A3D", "Azul Nexo"), ("#087CF0", "Azul eléctrico"), ("#FFD21C", "Amarillo"),
                   ("#F1263D", "Rojo"), ("#32D65B", "Verde"), ("#FF7A00", "Naranja"),
                   ("#9B45E8", "Violeta"), ("#15CBE8", "Cian")],
        "valores": "Curiosidad · Diversión · Inteligencia · Encuentro generacional",
        "ficha_extra": [("Conducción", "Sofía · Valentina · Emma · Tomás · Lucas"),
                        ("Redes", "@pequenosgrandessabios")],
