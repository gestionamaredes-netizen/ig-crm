...
- [ ] **Step 7: Actualizar los cuatro importadores**

En cada uno de estos archivos, cambiar el import de `formatearPesos`. Los archivos que importan **solo** `formatearPesos` desde metricas cambian la ruta entera:

`web/app/(app)/dashboard/page.tsx` línea 19, `web/components/dashboard/pautas-card.tsx` línea 2 y `web/components/marketing/tabla-campanas.tsx` línea 2:
...
`web/app/(app)/marketing/page.tsx` línea 2 es idéntico (importa solo `formatearPesos`):
...
```bash
git add web/lib/formato.ts web/lib/formato.test.ts web/lib/pautas/metricas.ts web/lib/pautas/metricas.test.ts "web/app/(app)/dashboard/page.tsx" "web/app/(app)/marketing/page.tsx" web/components/dashboard/pautas-card.tsx web/components/marketing/tabla-campanas.tsx
