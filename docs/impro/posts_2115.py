...
IMPRO_WM = Image.open(IMGS + "logo-impro-blanco.png").convert("RGBA")
M = 90
...
def p3():
    im = Image.new("RGB", (W, H), BG); d = ImageDraw.Draw(im)
    track(d, (M, 205), "N U E S T R O   P R I M E R   P R O Y E C T O", f(FB, 28), DIM, 3)
    lg = scaled(IMPRO_WM, 720); im.paste(lg, (M, 300), lg)
