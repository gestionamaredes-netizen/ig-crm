...
def e1():
    ...
    d.text((W//2,720),"Jueves 11 de septiembre",font=f(FB,54),fill=INK,anchor="ma")
...
def f1():
    ...
    d.text((W//2,H-250),"Jueves 11 de septiembre · 21:15",font=f(FB,44),fill=INK,anchor="ma")
...
def es_hist():
    ...
    d.text((SW//2,800),"Jue 11 de septiembre",font=f(FB,60),fill=INK,anchor="ma")
...
def films_hist():
    ...
    d.text((SW//2,SH-480),"Jue 11 de septiembre · 21:15",font=f(FB,48),fill=INK,anchor="ma")
